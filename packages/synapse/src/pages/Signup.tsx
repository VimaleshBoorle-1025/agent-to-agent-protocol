        ...
        <div style={{
          ...
          <div style={{ width: '100%', maxWidth: 400 }} className="anim-fade-up">
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
              <button className="social-btn" style={{ flex: 1 }} onClick={() => {
                if (REGISTRY) window.location.href = `${REGISTRY}/v1/auth/google`;
                else alert('Backend not configured. Set VITE_REGISTRY_URL to enable Google sign-in.');
              }}>
              ...
              <button className="social-btn" style={{ flex: 1 }} onClick={() => {
                ...
                else alert('Backend not configured. Set VITE_REGISTRY_URL to enable GitHub sign-in.');
              }}>
